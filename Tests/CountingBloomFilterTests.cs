...
public class CountingBloomFilterTests{
    ...
    public static void TestCreate(){
        IProbMembership<int> bf = new CountingBloomFilter<int>(5, 100);
        bf.AddToSet(5);
    ...
    public static void TestComputedCreate(){
        IProbMembership<int> bf = new CountingBloomFilter<int>(1, (float).000000000000000000001);
        bf.AddToSet(20);
    ...
    public static void TestOverlapFalsePositive(){
        IProbMembership<int> bf = new CountingBloomFilter<int>(1, 1);
        bf.AddToSet(55);
    ...
    public static void StringType(){
        IProbMembership<string> bf = new CountingBloomFilter<string>(5, 100);
        bf.AddToSet("IN");
    ...
    public static void ComplexDataType(){
        IProbMembership<IProbMembership<int>> bf = new CountingBloomFilter<IProbMembership<int>>(5, 100);
    ...
    [Fact]
    public static void ShouldRemoveAnElement(){
        CountingBloomFilter<int> bf = new CountingBloomFilter<int>(5, 100);
        bf.AddToSet(102);
        Assert.True(bf.ObjectInSet(102));
        bf.RemoveFromSet(102);
        Assert.False(bf.ObjectInSet(102));
        bf.AddToSet(103);
        Assert.True(bf.ObjectInSet(103));
    }
}